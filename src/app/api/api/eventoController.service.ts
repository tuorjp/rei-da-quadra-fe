...
export class EventoControllerService extends BaseService {
  ...
  /**
   * Lista eventos próximos baseados na geolocalização
   * @param lat Latitude do usuário
   * @param lon Longitude do usuário
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public listarEventosProximos(lat: number, lon: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<EventoResponseDTO>>;
  public listarEventosProximos(lat: number, lon: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<EventoResponseDTO>>>;
  public listarEventosProximos(lat: number, lon: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<EventoResponseDTO>>>;
  public listarEventosProximos(lat: number, lon: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {

    if (lat === null || lat === undefined) {
      throw new Error('Required parameter lat was null or undefined when calling listarEventosProximos.');
    }
    if (lon === null || lon === undefined) {
      throw new Error('Required parameter lon was null or undefined when calling listarEventosProximos.');
    }
    ...
    // Configuração dos Query Parameters (lat e lon)
    ...
    let localVarPath = `/eventos/proximos`;
    const { basePath, withCredentials } = this.configuration;
